...
<template>
  <section ref="root" class="px-6 py-20 md:py-28">
    <div class="finale-stagger mx-auto mb-10 max-w-xl text-center">
      <h2 class="script-title text-6xl md:text-7xl">{{ finale.title }}</h2>
      <p class="mt-3 text-inksoft">{{ finale.sub }}</p>
    </div>

    <div class="finale-stagger mx-auto max-w-3xl">
